    ...
    return (  
        <div className='h-[100vh] md:h-[110vh] w-full relative' style={{background: `url(${bg})`, backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}>
            ...
            <div className={`w-full h-full flex flex-col justify-center items-center absolute transform translate-y-[-10%] animate__animated animate__fadeIn`}>
                <h2 className='text-slate-200 text-3xl text font-bold mb-2 drop-shadow-xl'>Hi there,</h2>
                <h1 className='text-slate-200 text-4xl text font-bold mb-2'>I'm <span className='text-sky-500'>Bunde Uji</span></h1>
                <h2 className='text-slate-200 text-3xl text font-bold mb-2 cursor-pointer text-center'>Front-End Developer</h2>
                <ExploreBtn />
