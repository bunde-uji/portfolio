...
function ContactPage() {
    ...
    return (  
        <div className='bg-[#0d0d0d] h-[78vh] flex flex-col justify-center items-center'>
            ...
            <form ref={form} onSubmit={sendEmail} className='w-4/5 md:w-2/6 h-2/3 bg-[#2a2a2a] flex flex-col p-4 rounded-md items-center animate__animated animate__fadeIn'>
                ...
                <button type='submit' className='text-slate-200 font-[400] bg-sky-500 hover:bg-sky-400 w-full px-8 py-2.5 rounded-md text-center mt-3'>Submit</button>
            </form>
        </div>
    );
}
